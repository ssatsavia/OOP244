...
//  w5p2
//
//  Created by Sage Satsavia on 2024-02-26.
//
/***********************************************************************
...
int main() {
   Power powerlist1[4] = {
        Power("Flying", 2),
        Power("Laser Eye", 8),
        Power("Freezing Breath", 8),
        Power("Super Strength", 2)
    };

    Power powerlist2[2] = {
        Power("Super Speed", 8),
        Power("Super Healing", 5)
    };
    ...
    Power powerlist4[3] = {
        Power("Water Bending", 9),
        Power("Super Strength", 2),
        Power("Animal Telepathy", 9)
    };

    Power powerlist5[2] = {
        Power("Strong Will", 10),
        Power("Flying", 2)
    };

    Hero herolist[5] = {
        Hero ("Superman", powerlist1, 4),
        Hero("Flash",powerlist2, 2),
        Hero("Martian-Man-Hunter",powerlist3,3),
        Hero("Aquaman",powerlist4,3),
        Hero("Green-Lantern",powerlist5,2),
    };
    // Test 1
    cout << "----------------------------------------" << endl;
